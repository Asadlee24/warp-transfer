...
// Unambiguous alphabet: excludes confusing pairs (0/o, 1/l/i, 2/z, 5/s, 8/b, u/v)
// Extremely easy to read and type accurately between devices
function randomCode(len = 6) {
  const chars = "34679acdefghjkmnpqrtwxy";
  let out = "";
  for (let i = 0; i < len; i++) {
    ...
    return new Promise((resolve, reject) => {
      ...
      import("peerjs")
        .then((mod) => {
          ...
          const peer = id
            ? new Peer(id, { config: RTC_CONFIG, debug: 1 })
