...
// Fewer, well-chosen servers here means fewer ICE candidate messages that
// have to round-trip through the (shared, free) signaling broker before a
// connection can open — a long STUN/TURN list actually slows down
// "Connecting…" rather than speeding it up.
const RTC_CONFIG = {
  iceServers: [
