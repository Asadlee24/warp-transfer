...
// STUN & OpenRelay TURN for cross-network (Wi-Fi to Mobile Data) traversal
const RTC_CONFIG = {
  iceServers: [
      ...
      try {
        ...
        peer.on("connection", (conn) => {
              ...
              pc.oniceconnectionstatechange = () => {
                ...
                if (pc.iceConnectionState === "failed") {
                  ...
                  if (!streamStarted && myRunId === runIdRef.current) {
                    ...
                    setStatus("waiting");
                    setStatusText("Direct connection failed. Please re-enter code on receiver.");
                  }
                }
              };
            }
          ...
          conn.on("close", () => {
            ...
            if (!streamStarted) {
              setStatus("waiting");
              setStatusText("Receiver disconnected. Waiting for receiver...");
              return;
            }
